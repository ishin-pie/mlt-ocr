...
from modules.utils.util import converter, sort_poly, put_text_unicode
...
def demo(img, model, with_gpu=False):
    ...
    if len(boxes) != 0:
        ...
        for i, box in enumerate(boxes):
            ...
            origin = [box[0, 0], box[0, 1]]
            print(pred_transcripts[i])
            img = put_text_unicode(img, pred_transcripts[i], (origin[0], origin[1] - 18), font_size=16,
                                   color=(255, 0, 0))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', default='saved/MLT-OCR/model_best.pth.tar', help='path to model')
